...
def preprocess_model(input_model_path: str | Path, output_model_path: str | Path, preprocess_kwargs:dict=default_onnx_preprocess_kwargs) -> None:
    ...
    """
    try:
        kwargs = {**default_onnx_preprocess_kwargs, **preprocess_kwargs}
