...
def benchmark_yolo_fp(
    ...
    if onnx_benchmark_kwargs.get("half") is True:
        precision = "fp16"
    else:
        precision = "fp32"
    ...
    try:
        # Assuming export_to_onnx needs the path to the .pt file
        ...
        print(f"Error exporting model {organized_pt_path} to ONNX: {e}")
        return None
...
def benchmark_yolo_dynamic_quint8(
    
):
    pass


def benchmark_yolo_static_quint8(
